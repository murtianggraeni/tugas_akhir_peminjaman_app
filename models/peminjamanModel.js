...
function convertTimeStringToDate(timeString, tanggalPeminjaman) {
    ...
    console.log(`convertTimeStringToDate - timeString: ${timeString}, tanggalPeminjaman: ${tanggalPeminjaman}`);
    console.log(`Parsed peminjamanDate: ${peminjamanDate.toISOString()}`);
...
peminjamanSchema.pre('save', function(next) {
    ...
    console.log(`- Parsed peminjamanDate (UTC): ${peminjamanDate}`);
    console.log(`- Converted peminjamanDate (local): ${peminjamanLocal}`);
    ...
    if ((this.status === 'Menunggu' || this.status === 'Diproses') && new Date(now) > new Date(peminjamanLocal)) {
        ...
        console.log(`Peminjaman ${this._id} masih dalam batas waktu.`);
    }
